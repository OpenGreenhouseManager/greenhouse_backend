...
pub async fn get_filtered_alert(base_ulr: &str, query: AlertQuery) -> Result<Vec<AlertDto>> {
...
pub async fn create_alert(base_ulr: &str, alert: CreateAlertDto) -> Result<AlertDto> {
    let resp = reqwest::Client::new()
