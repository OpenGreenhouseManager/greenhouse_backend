...
use greenhouse_core::{scripting_dto, smart_device_dto::{activation::ActivateRequestDto, endpoints}};
...
pub(crate) async fn request_device_activate(device_address: &str, scripting_api: ActivateRequestDto) -> Result<String> {
    let resp = reqwest::Client::new()
